...
def first_window(event=None):
    ...
    for i in mat:
        ...
        text_type = Label(stroka, text=f'{i.type}', bg='#BBD9B2',
                          font=('Gabriolla', 12))
        text_type.place(x=5, y=5)

        text_name = Label(stroka, text=f'| {i.name}', bg='#BBD9B2',
                          font=('Gabriolla', 12))
        text_name.place(x=70, y=5)
        text_min_core = Label(stroka,
                              text=f'Минимальное количество: {i.min_core}',
        ...
        text_price = Label(stroka,
                           text=f'Цена: {i.edinisa} /единица измерения | \
                           {i.core_ypakovka}',
                           bg='#BBD9B2',  font=('Gabriolla', 9))
...
def two_window(event=None):
    ...
    messagebox.showinfo('Успешно',
                        'Соединение восстановлено, данные обновлены')
